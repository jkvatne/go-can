...
func VerifyDigOut(n *node.Node) {
	...
	n.SetPdoValue(1, 0, 2, 0x5500)
	SendPdos(n,5, 100*time.Millisecond)
	n.VerifyRangeFloat(INPUT_VALUE, 1, Vsupply-1.0, Vsupply+0.5, "DO1 high readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 2, 0.5, 4.5, "DO2 low readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 3, Vsupply-1.0, Vsupply+0.5, "DO3 high readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 4, 0.5, 4.5, "DO4 low readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 5, Vsupply-1.0, Vsupply+0.5, "DO5 high readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 6, 0.5, 4.5, "DO5 low readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 7, Vsupply-1.0, Vsupply+0.5, "DO6 high readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 8, Vsupply-1.0, Vsupply+0.5, "DO7 low readback" )
	n.SetPdoValue(1, 0, 2, 0xAA00)
	SendPdos(n,5, 100*time.Millisecond)
	n.VerifyRangeFloat(INPUT_VALUE, 1, 0.5, 4.5, "DO1 low readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 2, Vsupply-1.0,  Vsupply+0.5, "DO2 high readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 3, 0.5, 4.5, "DO3 low readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 4, Vsupply-1.0,  Vsupply+0.5, "DO4 high readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 5, 0.5, 4.5, "DO5 low readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 6, Vsupply-1.0,  Vsupply+0.5, "DO6 high readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 7, 0.5, 4.5, "DO7 low readback" )
	n.VerifyRangeFloat(INPUT_VALUE, 8, Vsupply-1.0,  Vsupply+0.5, "DO8 high readback" )
